...
Finding initial peers is not so easy. Adding 2 static nodes above may help fastboot, although it seems not be a permanent solution. You can configure static nodes by putting something like the following into &lt;datadir&gt;/static-nodes.json:
```
